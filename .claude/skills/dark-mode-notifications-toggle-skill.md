# Skill — Dark Mode NotificationsToggle (Piece 3c)

## Scope
Fix hardcoded light-only colors in the notifications toggle so it renders correctly in dark mode.

Modify:
- `components/settings/NotificationsToggle.tsx`
- `components/settings/__tests__/NotificationsToggle.test.tsx`

## Changes
1. `NotificationsToggle.tsx`
...
2. `NotificationsToggle.test.tsx`
...
`npx vitest run components/settings/__tests__/NotificationsToggle.test.tsx`

## Verification Checklist
- [ ] `NotificationsToggle.tsx` updated.
- [ ] `NotificationsToggle.test.tsx` updated and passing.
